...
#* Тудушки (бэк)
# Сделать так, чтобы категории были строго привязаны к проекту
# Дописать каскадное удаление тудушек в сервисе раздела
# Не забыть комментарии в модели проекта

#* Разделы (фронт)
# Переделать экран проекта, чтобы он вмещал экран тудушек и экран настроек

# Создание раздела
# Отображение разделов и их развёртка
# Тултип с меню при зажатии раздела
